                                    ...
                                    preprocessResponse(prettyPrint()),
                                        requestFields( //request 문서 작성
                                            fieldWithPath("loginId")
                                                    ...
                                                    .optional(), //필수여부
                                            fieldWithPath("pwd")
                                                    .description("사용자 비밀번호").attributes(Attributes.key("type").value("String")),
                                            fieldWithPath("email")
                                                    .description("사용자 이메일").attributes(Attributes.key("type").value("String")),
                                            fieldWithPath("phoneNumber")
                                                    .description("사용자 휴대폰 번호").attributes(Attributes.key("type").value("String"))
                                        ),
                                        responseFields(//response 문서 작성
                                                ...
                                                fieldWithPath("pwd").description("생성된 사용자 비밀번호")
                                                        .attributes(Attributes.key("type").value("String")),
                                                fieldWithPath("email").description("생성된 사용자 이메일")
                                                        .attributes(Attributes.key("type").value("String")),
                                                fieldWithPath("phoneNumber").description("생성된 사용자 휴대폰번호")
                                                        .attributes(Attributes.key("type").value("String")),
                                                fieldWithPath("statusMsg").description("회원가입 성공 여부")
                                                        .attributes(Attributes.key("type").value("String"))
                                        )
                                )
                ).andReturn();
